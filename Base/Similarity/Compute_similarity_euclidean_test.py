...
class MyTestCase(unittest.TestCase):
    ...
    def test_euclidean_similarity_integer(self):
        ...
        similarity_object = Compute_Similarity_Euclidean(sps.csr_matrix(data_matrix).T, topK=100, normalize=False,
        ...
        for vector1 in range(n_items):
            for vector2 in range(n_items):
                ...
                if vector1 == vector2:
                    assert W_local[vector1, vector2] == 0.0, "W_local[{},{}] not matching control".format(vector1,
                                                                                                          vector2)
