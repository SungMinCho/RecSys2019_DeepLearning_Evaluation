...
class Dataset(object):
    ...
    def __init__(self, path):
        ...
        self.user_feature, self.item_feature, self.type_feature, self.age_feature, self.occ_feature = self.load_feature_as_map(
            path + '.bpr.user_embedding', path + '.bpr.item_embedding', path + '.bpr.type_embedding', path + '.age_fea',
            path + '.occ_fea')
