...
class EpinionsReader(object):
    ...
    def __init__(self):
        ...
        try:
            ...
            self.URM_train, self.URM_validation, self.URM_test, self.URM_test_negative = split_train_validation_test_negative_leave_one_out_user_wise(
                URM_all, negative_items_per_positive=100)
