...
class SearchBayesianSkopt(SearchAbstractClass):
    ...
    def _objective_function(self, current_fit_parameters_dict):
        ...
        try:
            ...
            result_dict, _, recommender_instance, train_time, evaluation_time = self._evaluate(
            ...
            if self.save_metadata:
                ...
                self.metadata_dict["evaluation_time_avg"] = self.metadata_dict["evaluation_time_total"] / (
            ...
            if self.best_solution_val == None or self.best_solution_val < result_dict[self.metric_to_optimize]:
                ...
                if self.evaluator_test is not None:
                    ...
                    if self.save_metadata:
                        ...
                        self.metadata_dict["evaluation_test_time_avg"] = self.metadata_dict[
                                                                             "evaluation_test_time_total"] / tested_models
