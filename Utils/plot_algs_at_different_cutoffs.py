...
def plot_algs_at_different_cutoffs(evaluator, folder_path,
    ...
    for recommender2_name in recommender_dict_name_to_object.keys():
        ...
        for metric_to_plot in metric_list:
            results_dict_recommender1_x_values = [results_dict_recommender1[cutoff][metric_to_plot] for cutoff in
                                                  cutoff_list]
            results_dict_recommender2_x_values = [results_dict_recommender2[cutoff][metric_to_plot] for cutoff in
                                                  cutoff_list]
            ...
            plt.savefig(folder_path + "Metric value for different cutoff values_{}_{}_{}".format(recommender1_name,
                                                                                                 recommender2_name,
                                                                                                 metric_to_plot))
